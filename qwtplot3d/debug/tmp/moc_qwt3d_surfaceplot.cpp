...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Qwt3D__SurfacePlot_t, stringdata) + ofs \
...
const QMetaObject Qwt3D::SurfacePlot::staticMetaObject = {
    { &Plot3D::staticMetaObject, qt_meta_stringdata_Qwt3D__SurfacePlot.data,
      qt_meta_data_Qwt3D__SurfacePlot,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Qwt3D__SurfacePlot.stringdata))
